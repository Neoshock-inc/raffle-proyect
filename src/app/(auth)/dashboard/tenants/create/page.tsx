...
import { ArrowLeft, ArrowRight, Check, AlertCircle, Building2, Globe, Crown, UserPlus } from 'lucide-react'
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  <h4 className="text-base font-semibold text-amber-800">
                    Plan seleccionado: {data.selectedPlan && PLANS[data.selectedPlan] ? PLANS[data.selectedPlan].name : 'Ninguno'}
                  </h4>
                  <div className="mt-2 text-sm text-amber-700">
                    <p>{PLANS[data.selectedPlan].description}</p>
                    <p className="mt-2">
                      <strong>Costo:</strong> {PLANS[data.selectedPlan].price}
                      {data.selectedPlan !== 'basic' && ' por mes'}
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="ml-4">
                    ...
                    <div className="mt-3 text-sm text-sky-700">
                      <ul className="list-disc list-inside space-y-1">
                        ...
                        <li>Se registrará el dominio en el sistema</li>
                        <li>Se creará el usuario administrador</li>
                        <li>Se enviarán las credenciales de acceso por email</li>
                        <li>Recibirás instrucciones para configurar el DNS</li>
                      </ul>
                    </div>
                  </div>
                </div>
