            ...
            <div>
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                    <dl className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Nombre del Tenant</dt>
                        ...
                        <div>
                            ...
                            <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">{formatDate(tenant.created_at)}</dd>
                        </div>
                        <div>
                            <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Layout</dt>
                            <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">{tenant.layout || 'default'}</dd>
                        </div>
                    </dl>
                </div>
            </div>
