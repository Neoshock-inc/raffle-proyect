        ...
        <div className="p-6 space-y-8">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900">Configuración y Límites</h3>
                </div>
                <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                        <label className="flex items-center space-x-3 cursor-pointer">
                            ...
                            />
                            <div>
                                <span className="text-sm font-medium text-gray-700">Cuenta Regresiva</span>
                                <p className="text-xs text-gray-500">Muestra el tiempo restante hasta el sorteo</p>
                            </div>
                        </label>
                    </div>
                    ...
                    <div className="space-y-3">
                        <label className="flex items-center space-x-3 cursor-pointer">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500">Muestra el progreso de tickets vendidos</p>
                            </div>
                        </label>
                    </div>
                </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h4 className="text-md font-medium text-gray-900 mb-4">Resumen de Configuración Actual</h4>
